  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`email`,`username`,`game`,`rank`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getGame() == null) {
          ...
          statement.bindString(4, entity.getGame());
        }
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            if (_cursor.isNull(_cursorIndexOfGame)) {
              _tmpGame = null;
            } else {
            ...
            _result = new User(_tmpId,_tmpEmail,_tmpUsername,_tmpGame,_tmpRank);
          } else {
            _result = null;
          }
          return _result;
